...
object AttributeRegistry {
    ...
    val CRITICAL_CHANCE by ATTRIBUTES.registerObject(CriticalChance.descriptionId) {
        CriticalChance
    }

    val CRITICAL_DAMAGE by ATTRIBUTES.registerObject(CriticalDamage.descriptionId) {
        CriticalDamage
    }
}
